(() => {
  ...
  const API_COMMANDS = Object.freeze([
    ...
    "openLocalRepository","cloneRepository","setRepositoryTrust","createTaskWorkspace","createIntegrationWorkspace","materializeTaskArtifact","verifyWorkspace","commitWorkspace","mergeTaskArtifact","pushWorkspace","cleanupWorkspace"
  ]);
  ...
  const API_QUERIES = Object.freeze([
    ...
    "repositories","repository","workspaceStatus","workspaceDiff","workspaceArtifact","workspaceScope"
  ]);
